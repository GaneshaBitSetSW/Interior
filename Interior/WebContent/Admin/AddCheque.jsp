...
<title>Interior :: Add Cheque</title>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                    	<li><a class = "active" href="AddCheque">Add Cheque</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Cheque Date : </label>
	                            <div class="col-md-7 form-group">
                            ...
                            <div class="col-md-6 form-group" style = "">
	                            ...
	                            <div class="col-md-7 form-group">
	                                <input type="text" placeholder=".col-md-6" value = "Validation digits Only" class="form-control">
	                            </div>
	                            <div class="col-md-1 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Bank Name : </label>
	                            <div class="col-md-7 form-group">
	                                <input type="text" placeholder=".col-md-6" value = "Validation Characters Only" class="form-control">
	                            </div>
	                            <div class="col-md-1 form-group">
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Cheque Photo : </label>
	                            <div class="col-md-7 form-group">
                            ...
                            <div class="col-md-6 form-group">
	                            ...
	                            <div class="col-md-7 form-group">
	                                ...
	                                <div class="input-group m-bot15">
		                                <input type="text" value = "Validation digits Only" class="form-control">
                            ...
                            <div class="col-md-6 form-group" style = "margin-top:-20px;">
	                            ...
	                            <div class="col-md-7 form-group">
	                                <input type="text" placeholder=".col-md-6" id = "time" readonly="readonly" class="form-control">
	                            </div>
	                            <div class="col-md-1 form-group">
...
function startTime() {
    ...
    document.getElementById('time').value = day +"-"+ month +"-"+ year +" "+ h + ":" + m + ":" + s;
