...
<title>Interior :: Add Bill By Shop</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class = "active" href="AddBillByShop">Add Bill By Shop</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Bill No : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Shop Name : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Shop Mob. No. : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Total Amount : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>Shop Name</center></th>
            <th style = "color:white;"><center>Mobile</center></th>
            <th style = "color:white;"><center>Amount</center></th>
            <th style = "color:white;"><center>Photo</center></th>
        ...
        <tbody>
          <tr>
          	...
          	<td><center>1212121212</center></td>
          	<td><center>10,000.00</center></td>
          	<td><center>Photo Link</center></td>
          	<td><center>Pending</center></td>
          </tr>
          <tr>
          	<td>2</td>
          	<td><center>Yogesh Chandra</center></td>
          	<td><center>2121212121</center></td>
          	<td><center>10,000.00</center></td>
          	<td><center>Photo Link</center></td>
