...
<title>Interior :: Client Details</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a class = "active" href="ClientDetails">Client Details</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;">
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                    		...
                    		<div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Date From : </label>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Date To : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="date" class="form-control">
	                            </div>
                            </div>
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            <th style = "color:white;"><center>SN</center></th>
            <th style = "color:white;"><center>Name</center></th>
            <th style = "color:white;"><center>Mobile</center></th>
            <th style = "color:white;"><center>WorkSite Name</center></th>
            <th style = "color:white;"><center>GST No.</center></th>
            <th style = "color:white;"><center>Aadhar Card</center></th>
            <th style = "color:white;"><center>Trans. Id</center></th>
            <th style = "color:white;"><center>Trans. Date</center></th>
        ...
        <tbody>
          <tr>
          	...
          	<td><center>GST No.</center></td>
          	<td><center>9865 3221 2211</center></td>
          ...
          <tr>
          	...
          	<td><center>Suraj Nikam</center></td>
          	<td><center>1221 2525 7878</center></td>
          	<td><center>Trans. Id</center></td>
          	<td><center>12-03-2018</center></td>
          	<td><center><a href = "#">Edit</a></center></td>
          	<td><center><a href = "#">View</a></center></td>  
