...
<title>Interior :: Add Project</title>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    ...
                    <ul class="sub">
						<li><a class = "active" href="AddProject">Add Project</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
            ...
            <div class="panel-body" style = "" >
                <form class="form-horizontal bucket-form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" value = "Validation Characters Only">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Work Type : </label>
                        <div class="col-sm-6">
                            <textarea class="form-control" rows = "3" cols = "60">Validation Characters Only</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Email Id : </label>
                        <div class="col-sm-6">
                            <input type="email" class="form-control" value = "Validation Email" required = "@">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Mobile : </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" value = "Validation 10 digits Only">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="inputEmail1" class="col-lg-6 col-sm-6 control-label" style = "text-align: left;color:green;">Data Is Inserted</label>
                    ...
                    <div class="col-md-6 form-group" style = "">
                       <button type="submit" class="btn btn-success" style = "margin-left:0px;">Submit</button>
                       <a href = "#" style = "color:white;"><button type="submit" class="btn btn-success" style = "float:right;">Project List</button></a>
	                </div>
