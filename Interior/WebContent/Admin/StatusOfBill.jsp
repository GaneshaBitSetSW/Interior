...
<title>Interior :: Status Of Bill</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class = "active" href="StatusOfBill">Status of All Bill</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>Builder Name</center></th>
            <th style = "color:white;"><center>Site Name</center></th>
            <th style = "color:white;"><center>Site Address</center></th>
            <th style = "color:white;"><center>Payment</center></th>
            <th style = "color:white;"><center>All Cheques</center></th>
            <th style = "color:white;"><center>Cheque Status</center></th>
        ...
        <tbody>
          <tr>
          	...
          	<td><center>Swaregate</center></td>
          	<td><center>10,000.00</center></td>
          	<td><center>Cheque</center></td>
