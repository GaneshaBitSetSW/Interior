...
<title>Interior :: Attendance Report</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class = "active" href="WorkersAttendanceReport">Worker Attendance Report</a></li>
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            <th style = "color:white;"><center>Emp. Id</center></th>
            <th style = "color:white;"><center>Name</center></th>
            <th style = "color:white;"><center>Date</center></th>
            <th style = "color:white;"><center>Attend</center></th>
            <th style = "color:white;"><center>InTime</center></th>
            <th style = "color:white;"><center>OutTime</center></th>
            <th style = "color:white;"><center>Daily W. Hours</center></th>
            <th style = "color:white;"><center>Overtime W. Hours</center></th>
