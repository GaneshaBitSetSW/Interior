        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a class="active" href="AddSizeOfFlat">Add Size Of Flat</a></li>
                        ...
                        <div class="position-center" style = "width: 100%;">
                            ...
                            <div class="col-md-6 form-group" style = "">
	                            ...
	                            <div class="col-md-8 form-group" style = "">
	                                ...
	                                <!-- <a href = "AddSizeOfFlatList"><button type="submit" class="btn btn-success" style = "float:right;margin-right:10px;">Flat Size List</button></a> -->
	                            </div>
                            </div>
                        </form>    
                       </div>
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>RoomSize</center></th>
