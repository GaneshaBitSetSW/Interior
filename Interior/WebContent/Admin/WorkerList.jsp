...
<title>Interior :: Worker List</title>
                            ...
                            <div class="col-md-6 form-group" style = "">
	                            ...
	                            <div class="col-md-6 form-group" style = "">
	                                <select class = "form-control" name = "workType">
	                            		...
	                            		<option value = "0">Name (A-Z)</option>
	                            		<option value = "1">Name (Z-A)</option>
	                            		<option value = "2">DOJ (Ascending)</option>
	                            		<option value = "3">DOJ (Descending)</option>
	                            	</select>
	                            </div>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <tr>
          	...
          	<td><center><a href = "#"><i class="fa fa-edit"></i></a> / <a href = "#"><i class="fa fa-times-circle-o"></i></a></center></td>
