...
<title>Interior :: Cheque Details</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class = "active" href="ChequeDetails">Cheque Details</a></li>
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                    		...
                    		<div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Select Date : </label>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Cheque No : </label>
	                            <div class="col-md-8 form-group" style = "">
                            ...
                            <div class="col-md-6 form-group" style = "">
	                            ...
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control" value = "After C.NO. Enter then Name From DB" readonly="readonly">
	                            </div> 
                            </div>
                            
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Sort By : </label>
	                            <div class="col-md-6 form-group" style = "">
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            <th style = "color:white;"><center>C. No</center></th>
            <th style = "color:white;"><center>C. Name</center></th>
            <th style = "color:white;"><center>C. Date</center></th>
            <th style = "color:white;"><center>Bank Name</center></th>
            <th style = "color:white;"><center>Amount</center></th>
            <th style = "color:white;"><center>C. Image</center></th>
            <th style = "color:white;"><center>C & B</center></th>
        ...
        <tbody>
          <tr>
          	<td>1</td>
          	<td><center>ABC XYZ</center></td>
          	<td><center>12-03-2018</center></td>
          	<td><center>SBI</center></td>
          	<td><center>10,000.00</center></td>
