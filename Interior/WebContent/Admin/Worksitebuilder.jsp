            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class = "active" href="WorksiteBillBuilders">All Worksite Bill by  Builders</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Place : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Total Payment : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <input type="text" class="form-control">
	                            </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Action : </label>
	                            <div class="col-md-8 form-group" style = "">
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>Place</center></th>
            <th style = "color:white;"><center>Amount</center></th>
            <th style = "color:white;"><center>Bill Date</center></th>
