...
<title>Interior :: Payment Report</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="PaymentReport" class = "active">Worker Salary Report</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
...
<section id="main-content">
  ...
  <div class="panel panel-default">
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>Daily Pay</center></th>
            <th style = "color:white;"><center>OverT Pay</center></th>
            <th style = "color:white;"><center>Gross Payment</center></th>
        ...
        <tbody>
          <tr>
          	...
          	<td style = "text-align:right;"><b>10,000.00</b></td>
          ...
          <tr>
          	...
          	<td style = "text-align:right;"><b>10,050.00</b></td>
          	<td><center><a href = "#">Edit</a></center></td>
          	<td><center><a href = "#">View</a></center></td>  
          </tr>
    ...
    <footer class="panel-footer">
       <div class="row">
        <div class="col-sm-6">
          	<label for="inputEmail1" style = "text-align: left;color:green;">Salary Report Loaded Successfully.</label>
        </div>
        <div class="col-sm-3">                
          	
        </div>
        <div class="col-sm-3">
        	<button type="submit" class="btn btn-success" style = "float:right;">Paid</button>
        </div>
      </div>
    </footer>
  </div>
