...
<title>Interior :: OverTime Attendance Report</title>
        	...
        	<div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading"> 
						WORKER's OVERTIME ATTENDANCE SHEET
                    </header>
                    <div class="panel-body">
						...
						<form class="form-horizontal" role="form" style = "">
                            ...
                            <div class="col-md-6 form-group" style = "">
		                        ...
		                        <div class="col-md-3 form-group" style = "">
		                            <input type="text" class="form-control" value = "19:30:00">
		                        </div>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <tr>
          	...
          	<td><center><input type = "radio" name = "attend1"> P <input type = "radio" name = "attend1" style= "margin-left:10px;"> A</center></td>
...
<!--       <div class="row">
 ...
 -->
       <div class="row">
        <div class="col-sm-6">
          	<label for="inputEmail1" style = "text-align: left;color:green;">OverTime Attendance Successfully.</label>
        </div>
        <div class="col-sm-3">                
        ...
        <div class="col-sm-3">
        	...
        	<a href = "DailyAttendance"><button type="submit" class="btn btn-success" style = "float:right;margin-right:10px;">Daily</button></a>
        </div>
      </div>
    </footer>
  </div>
