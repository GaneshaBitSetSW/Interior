...
<title>Interior :: Add Room Size</title>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="active" href="AddRoomSize">Add Room Size</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center" style = "width: 100%;">
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Size Type : </label>
	                            <div class="col-md-8 form-group" style = "">
                            ...
                            <div class="col-md-6 form-group" style = "">
                                <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label" style = "text-align: left">Room Type : </label>
	                            <div class="col-md-8 form-group" style = "">
	                                <select class = "form-control" name = "roomType">
	                            		<option value = "-1">Select Room Type (From DB)</option>
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr style = "background-color:rgb(84,132,154);">
            ...
            <th style = "color:white;"><center>Size Type</center></th>
